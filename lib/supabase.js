...
// ─── Headers ─────────────────────────────────────────────────────────────────
// El backend SIEMPRE prefiere la service key: con el RLS cerrado
// (supabase/rls-lockdown.sql) la anon key ya no puede escribir, así que si
// SUPABASE_SERVICE_KEY falta en el entorno, las escrituras fallarían.
// El fallback a anon existe solo para no romper lecturas en dev sin la key.
