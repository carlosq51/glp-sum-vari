...
export const CONFIG_DEFAULTS = {
  ...
  //
  // Nació como permiso nominal para Cahuana, que trabaja con ayudantes que no
  ...
  // tener ayuda. Esa situación no es suya: cualquier técnico puede tener ayuda
  // un día, o simplemente estar listo para abrir el siguiente carro mientras
  // cierra el que tiene. Abierto a todo el taller (2026-08-17).
  //
  // El techo sigue siendo un carro por rol a la vez para el resto del reparto:
  // esto no reparte de más, solo deja que lo pidan ellos.
