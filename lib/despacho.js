 ...
 *
 * También es lo que gasta el turno de la regla: apoyar es apoyar, lo haya
 * decidido el motor o el supervisor, y quien ya apoyó hoy no vuelve a apoyar.
 */
 ...
 *   · que el puesto tenga titular a quien ayudar
...
export function validarAyudante_({ ancla, ayudante, duplaDelAyudante = null } = {}) {
  if (!ancla?.user_id)    return { ok: false, error: "Ese puesto no tiene a nadie todavía" };
