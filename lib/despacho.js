 ...
 *
 * Nació como excepción nominal: quien trabaja con ayudantes que no marcan
 * asistencia no puede formar dupla en el sistema, aunque en el taller la
 * tenga de hecho. Resultó que esa situación es la norma y no la excepción
 * —cualquier técnico puede tener ayuda un día— así que el permiso pasó a
 * ser de todos. La lista nominal sigue funcionando por si hay que volver a
 * cerrarlo a unos pocos sin tocar código.
 */
