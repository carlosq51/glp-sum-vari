 ...
 * DESPACHO_AVANCE_SOLO (user_id separados por coma).
 *
 * Existe por un caso real: hay quien trabaja con ayudantes que no marcan
 * asistencia y por tanto no pueden formar dupla en el sistema, aunque en el
 * taller la tenga de hecho. Sin la excepción tendría que elegir entre
