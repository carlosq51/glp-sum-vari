...
/**
 * Estado efectivo para el despacho. PRESENTE se vuelve DISPONIBLE recién
 * cuando arranca el turno: el técnico llega 06:00 pero el trabajo se reparte
 * desde las 07:00.
 */
export function estadoEfectivo_(estado, { turnoInicioMin, ahoraMin, tieneTrabajo }) {
  if (estado === "FUERA" || estado === "PAUSA") return estado;
  if (tieneTrabajo) return "OCUPADO";
  if (ahoraMin < turnoInicioMin) return "PRESENTE";
  return "DISPONIBLE";
}
