...
/**
 * Estados en los que una OT de CALIDAD ajena se le MUESTRA al otro inspector.
 *
 * Es la misma frontera que aplica puedeColaborar_ ("solo si el titular ya
 * empezó"), escrita una vez para que la lista y el permiso no se separen: si la
 * pantalla enseñara una OT que el permiso rechaza, el inspector la tocaría y
 * recibiría un 409 sin entender por qué.
 *
 * FINALIZADO queda fuera por otro motivo: ahí la OT ya no es trabajo, es
 * historial, y el historial es de quien la registró.
 */
export const ESTADOS_CALIDAD_COLABORATIVA = ["TRABAJANDO", "PAUSADO"];
