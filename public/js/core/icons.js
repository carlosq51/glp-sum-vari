...
// Sistema de iconos SVG (stroke, 24x24, currentColor)
// Reemplaza los emojis de las cartillas: nítidos, theme-aware
// y coloreables vía CSS (color / --tone).
// =========================
...
const ICONS = {
  ...
  trayIn:
    '<path d="M12 3v10"/><path d="m8 9 4 4 4-4"/><path d="M8 5H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-4"/>',
  trayOut:
    '<path d="M12 13V3"/><path d="m8 7 4-4 4 4"/><path d="M8 9H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-4"/>',
  clock:
  ...
  calendar:
    '<path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h21"/>',
  timer:
 ...
 * Hereda color vía `currentColor`; el tamaño por defecto es 20px.
 */
