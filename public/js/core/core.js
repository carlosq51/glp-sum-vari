...
// --- Supabase client (solo lectura desde el navegador; las escrituras
// van por el backend — paso 2 del plan de seguridad) ---
export { supabaseEnabled, supabaseGet } from "./supabase-client.js";
